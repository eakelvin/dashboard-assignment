...
const Dashboard = () => {
    ...
    return (
        <div className='border-t-2 border-gray-200'>
            <div className='grid lg:grid-cols-[7.5fr_2.5fr] h-screen'>
                <div className=' py-2'>
                                            ...
                                            <CardContent>
                                                ...
                                                <CardTitle className="text-lg">
                                                    ...
                                                    <span className='text-lime-400'>
                                                        {report?.data.update.percentage_change}
                                                    </span>
                                                    {''} in 1 week
                                                </CardTitle>
                                            </CardContent>
                ...
                <div className='lg:pl-4 lg:mt-4'>
                    {report?.data.total_view_perfomance ? (
                        <Card>
